...
Hooks.once("init", () => {
    (game as any).settings.register("pf2e-ai-npc-generator", "apiKey", {
    ...
    (game as any).settings.register("pf2e-ai-npc-generator", "lastPrompt", {
    ...
    (game as any).settings.register("pf2e-ai-npc-generator", "lastLevel", {
        name: "Last NPC Level",
        scope: "client",
        config: false,
        type: Number,
